...
export const JobsCancel = rpcAction(CONTRACT_ID, "Jobs.Cancel", {
...
export const JobsDismissDLQ = rpcAction(CONTRACT_ID, "Jobs.DismissDLQ", {
...
export const JobsGetKey = rpcAction(CONTRACT_ID, "Jobs.GetKey", {
...
export const JobsInspect = rpcAction(CONTRACT_ID, "Jobs.Inspect", {
...
export const JobsListDLQ = rpcAction(CONTRACT_ID, "Jobs.ListDLQ", {
...
export const JobsListServices = rpcAction(CONTRACT_ID, "Jobs.ListServices", {
...
export const JobsMetrics = rpcAction(CONTRACT_ID, "Jobs.Metrics", {
...
export const JobsQuery = rpcAction(CONTRACT_ID, "Jobs.Query", {
...
export const JobsReplayDLQ = rpcAction(CONTRACT_ID, "Jobs.ReplayDLQ", {
...
export const JobsRetry = rpcAction(CONTRACT_ID, "Jobs.Retry", {
...
export const JobsWatch = feedAction(CONTRACT_ID, "Jobs.Watch", {
