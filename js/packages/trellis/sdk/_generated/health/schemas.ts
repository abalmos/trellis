...
export const HealthInspectRequestSchema = {
  "properties": {
    "contractId": { "maxLength": 256, "minLength": 1, "type": "string" },
...
export const HealthInspectResponseSchema = {
  "properties": {
...
export const HealthMetricsRequestSchema = {
  "properties": {
    "checkNames": {
...
export const HealthMetricsResponseSchema = {
  "properties": {
    "asOf": { "format": "date-time", "type": "string" },
    "projection": {
      "properties": {
...
export const HealthQueryRequestSchema = {
  "properties": {
    "contractIds": {
...
export const HealthQueryResponseSchema = {
  "properties": {
    "asOf": { "format": "date-time", "type": "string" },
...
export const HealthStatusChangedEventSchema = {
  "properties": {
...
export const HealthWatchFrameSchema = {
  "anyOf": [{
    "properties": {
...
export const HealthWatchRequestSchema = {
  "properties": {
    "contractIds": {
      "items": { "maxLength": 256, "minLength": 1, "type": "string" },
      "maxItems": 100,
