...
export const HealthInspect = rpcAction(CONTRACT_ID, "Health.Inspect", {
...
export const HealthMetrics = rpcAction(CONTRACT_ID, "Health.Metrics", {
...
export const HealthQuery = rpcAction(CONTRACT_ID, "Health.Query", {
...
export const HealthWatch = feedAction(CONTRACT_ID, "Health.Watch", {
