...
| `trellis.feed.active`                       | Rust `trellis/src/live/subscription.rs` client + `provider_engine.rs` provider                              | `FeedGuard` unit test; source inspected                       |
| `trellis.feed.active`                       | TS `session.ts` client + `live/provider.ts` server Feed ownership                                           | executed boundary; real Feed case                             |
| `trellis.feed.ends`                         | Rust `trellis/src/live/subscription.rs` client + `provider_engine.rs` provider                              | `FeedGuard` unit test; source inspected                       |
| `trellis.feed.ends`                         | TS `session.ts` client + `live/provider.ts` server Feed ownership                                           | executed boundary; real Feed case                             |
