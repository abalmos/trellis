...
| `trellis.feed.active`                       | TS `session.ts` client/server Feed ownership                                                                | executed boundary; real Feed case                             |
| `trellis.feed.ends`                         | Rust `trellis/src/client/connection.rs` feed guard                                                          | source inspected                                              |
| `trellis.feed.ends`                         | TS `session.ts` client/server Feed ownership                                                                | executed boundary; real Feed case                             |
