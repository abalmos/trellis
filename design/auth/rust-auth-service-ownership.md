...
| Built-in portal assets           | `auth/http/builtin_portal.ts`; source under `ts/portals/login`                                                                                                          | Compiled static output                                                                         | `/_trellis/portal/*`, `/_trellis/assets/*`                                                    | Preserve existing UI without a production filesystem mount                                                                                                                                                                   | Rust embedded-asset HTTP adapter; Svelte remains source                                                | migrate                                  |
