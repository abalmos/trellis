...
base64, timestamps are canonical UTC RFC3339, ULIDs are uppercase, and numbers
must be finite. Administrative JSON documents use bytes with documented UTF-8
