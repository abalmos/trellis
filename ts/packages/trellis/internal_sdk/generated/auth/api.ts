...
export const API_DIGEST =
  "2SIHWPDpaMZDtLkeROx_n12RMcraO2dUcqk-GVstWgQ" as const;
export const API = {
  "capabilities": {
    "trellis.auth::authorities.mutate": {
      "allows": [{
        ...
        "target": {
          "api": "trellis.auth@v1",
          "kind": "apiSurface",
          "name": "Auth.Participants.Install",
          "surface": "rpc",
        },
      }],
    },
  ...
  "rpc": {
    ...
    "Auth.Deployments.Get": {
      "errors": ["AuthError", "UnexpectedError", "ValidationError"],
      "input": { "schema": "AuthDeploymentsGetRequest" },
      "output": { "schema": "AuthDeploymentsGetResponse" },
      "version": "v1",
    },
    ...
    "Auth.Grants.List": {
      "errors": ["AuthError", "UnexpectedError", "ValidationError"],
      "input": { "schema": "AuthGrantsListRequest" },
      "output": { "schema": "AuthGrantsListResponse" },
      "version": "v1",
    },
    "Auth.Grants.Revoke": {
      "errors": ["AuthError", "UnexpectedError", "ValidationError"],
    ...
    "Auth.Participants.Get": {
      "errors": ["AuthError", "UnexpectedError", "ValidationError"],
      "input": { "schema": "AuthParticipantsGetRequest" },
      "output": { "schema": "AuthParticipantsGetResponse" },
      "version": "v1",
    },
  ...
  "schemas": {
    ...
    "AuthCapabilitiesListResponseentriesItem": {
      "properties": {
        "allows": {
          "items": {
            "properties": {
    ...
    "AuthCapabilitiesListResponseentriesItemallowsItem": {
      "properties": {
        "action": {
          "anyOf": [
            { "const": "call", "type": "string" },
    ...
    "AuthCapabilitiesListResponseentriesItemallowsItemtarget1": {
      "properties": {
        "api": { "minLength": 1, "type": "string" },
        "kind": { "const": "apiSurface", "type": "string" },
        "name": { "minLength": 1, "type": "string" },
    ...
    "AuthCapabilitiesListResponseentriesItemallowsItemtarget2": {
      "properties": {
        "api": { "minLength": 1, "type": "string" },
        "kind": { "const": "operationSignal", "type": "string" },
        "operation": { "minLength": 1, "type": "string" },
    ...
    "AuthCapabilitiesListResponseentriesItemallowsItemtarget3": {
      "properties": {
        "kind": { "const": "participantResource", "type": "string" },
        "name": { "minLength": 1, "type": "string" },
        "participant": { "minLength": 1, "type": "string" },
    ...
    "AuthCapabilityGroupsGetResponsegroup": {
      "properties": {
        "capabilities": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthCapabilityGroupsListResponseentriesItem": {
      "properties": {
        "capabilities": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthCapabilityGroupsPutResponsegroup": {
      "properties": {
        "capabilities": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthConnectionsListResponseentriesItem": {
      "properties": {
        "clientId": { "minLength": 1, "type": "string" },
        "connectedAt": {
          "maximum": 9007199254740991,
        ...
        "connectionId": { "minLength": 1, "type": "string" },
        "contextDigest": { "pattern": "^[A-Za-z0-9_-]{43}$", "type": "string" },
        "deploymentId": {
    ...
    "AuthDeploymentsCreateResponsedeployment": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthDeploymentsDisableResponsedeployment": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthDeploymentsDisableResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthDeploymentsEnableResponsedeployment": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthDeploymentsEnableResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthDeploymentsGetRequest": {
      "properties": { "deploymentId": { "minLength": 1, "type": "string" } },
      "required": ["deploymentId"],
      "type": "object",
    },
    "AuthDeploymentsGetResponse": {
      "properties": {
        "binding": {
          "anyOf": [{
            "properties": {
    ...
    "AuthDeploymentsListResponseentriesItem": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthDeploymentsRemoveResponsedeployment": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthDeploymentsRemoveResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthDeviceUserAuthoritiesListResponseentriesItem": {
      "properties": {
        "device": {
          "properties": {
            "administrativeApproval": {
            ...
            "identityKeyId": {
              "anyOf": [
                { "pattern": "^[A-Za-z0-9_-]{43}$", "type": "string" },
                { "type": "null" },
              ],
            },
            "identityPublicKey": {
    ...
    "AuthDeviceUserAuthoritiesListResponseentriesItemdevice": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDeviceUserAuthoritiesResolveResponsedevice": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDeviceUserAuthoritiesResolveResponsereview": {
      "properties": {
        "activatedByUserPrincipalId": {
          "anyOf": [{ "type": "string" }, { "type": "null" }],
        },
    ...
    "AuthDeviceUserAuthoritiesReviewsDecideResponsereview": {
      "properties": {
        "activatedByUserPrincipalId": {
          "anyOf": [{ "type": "string" }, { "type": "null" }],
        },
    ...
    "AuthDeviceUserAuthoritiesReviewsListResponseentriesItem": {
      "properties": {
        "activatedByUserPrincipalId": {
          "anyOf": [{ "type": "string" }, { "type": "null" }],
        },
    ...
    "AuthDeviceUserAuthoritiesRevokeResponsedevice": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDevicesDisableResponsedevice": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDevicesDisableResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthDevicesEnableResponsedevice": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDevicesEnableResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthDevicesListResponseentriesItem": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDevicesProvisionResponsedevice": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDevicesRemoveResponsedevice": {
      "properties": {
        "administrativeApproval": {
          "anyOf": [
            { "const": "pending", "type": "string" },
    ...
    "AuthDevicesRemoveResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthPortalsGetResponseportalloginSettings": {
      "properties": {
        "federatedRegistration": { "type": "boolean" },
        "localLogin": { "type": "boolean" },
        "localRegistration": { "type": "boolean" },
    ...
    "AuthPortalsGetResponseroutesItem": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthPortalsGrantOverridesListResponseentriesItem": {
      "properties": {
        "capabilityGroupKeys": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthPortalsGrantOverridesListResponseentriesItemroleMappingsItem": {
      "properties": {
        "capabilityGroupKeys": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthPortalsGrantOverridesPutRequestroleMappingsItem": {
      "properties": {
        "capabilityGroupKeys": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthPortalsGrantOverridesPutResponsepolicy": {
      "properties": {
        "capabilityGroupKeys": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthPortalsGrantOverridesPutResponsepolicyroleMappingsItem": {
      "properties": {
        "capabilityGroupKeys": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthPortalsGrantOverridesRemoveResponseremoved": {
      "properties": {
        "capabilityGroupKeys": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthPortalsGrantOverridesRemoveResponseremovedroleMappingsItem": {
      "properties": {
        "capabilityGroupKeys": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthPortalsListResponseentriesItem": {
      "properties": {
        "builtIn": { "type": "boolean" },
        "createdAt": {
          "maximum": 9007199254740991,
    ...
    "AuthPortalsListResponseentriesItemloginSettings": {
      "properties": {
        "federatedRegistration": { "type": "boolean" },
        "localLogin": { "type": "boolean" },
        "localRegistration": { "type": "boolean" },
    ...
    "AuthPortalsLoginSettingsGetResponsesettings": {
      "properties": {
        "federatedRegistration": { "type": "boolean" },
        "localLogin": { "type": "boolean" },
        "localRegistration": { "type": "boolean" },
    ...
    "AuthPortalsLoginSettingsUpdateRequestsettings": {
      "properties": {
        "federatedRegistration": { "type": "boolean" },
        "localLogin": { "type": "boolean" },
        "localRegistration": { "type": "boolean" },
    ...
    "AuthPortalsLoginSettingsUpdateResponsesettings": {
      "properties": {
        "federatedRegistration": { "type": "boolean" },
        "localLogin": { "type": "boolean" },
        "localRegistration": { "type": "boolean" },
    ...
    "AuthPortalsPutRequestloginSettings": {
      "properties": {
        "federatedRegistration": { "type": "boolean" },
        "localLogin": { "type": "boolean" },
        "localRegistration": { "type": "boolean" },
    ...
    "AuthPortalsPutResponseportalloginSettings": {
      "properties": {
        "federatedRegistration": { "type": "boolean" },
        "localLogin": { "type": "boolean" },
        "localRegistration": { "type": "boolean" },
    ...
    "AuthPortalsRoutesPutResponseroute": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthResourceEventConsumerProvider": {
      "properties": {
        "consumer": { "minLength": 1, "type": "string" },
        "filterSubjects": {
          "items": { "minLength": 1, "type": "string" },
    ...
    "AuthServiceInstancesDisableResponseinstance": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthServiceInstancesDisableResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthServiceInstancesEnableResponseinstance": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthServiceInstancesEnableResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthServiceInstancesListResponseentriesItem": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthServiceInstancesProvisionResponseinstance": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthServiceInstancesRemoveResponseinstance": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthServiceInstancesRemoveResponsemutation": {
      "properties": {
        "changed": { "type": "boolean" },
        "resourceId": { "minLength": 1, "type": "string" },
        "state": { "minLength": 1, "type": "string" },
    ...
    "AuthUserIdentitiesListResponseentriesItem": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
        ...
        "observedName": { "anyOf": [{ "type": "string" }, { "type": "null" }] },
        "principalId": { "minLength": 1, "type": "string" },
        "providerId": { "minLength": 1, "type": "string" },
        "subject": { "minLength": 1, "type": "string" },
    ...
    "AuthUsersIdentityLinkCreateResponseflow": {
      "properties": {
        "allowedProviders": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthUsersListResponseentriesItem": {
      "properties": {
        "createdAt": {
          "maximum": 9007199254740991,
          "minimum": 0,
    ...
    "AuthUsersPasswordResetCreateResponseflow": {
      "properties": {
        "allowedProviders": {
          "items": { "minLength": 1, "type": "string" },
          "type": "array",
    ...
    "AuthUsersResolveRequestselector1": {
      "properties": {
        "kind": { "const": "user", "type": "string" },
        "userId": { "minLength": 1, "type": "string" },
      },
    ...
    "AuthUsersResolveRequestselector2": {
      "properties": {
        "kind": { "const": "provider", "type": "string" },
        "providerId": { "minLength": 1, "type": "string" },
        "providerSubject": { "minLength": 1, "type": "string" },
    ...
    "PortalGrantProvenance": {
      ...
      "required": ["portalId", "providerId", "roles", "effectivePolicyDigest"],
      "type": "object",
    },
  },
  "version": "1.0.0",
