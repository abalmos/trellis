...
export function createResourcesFixture(caseId: string) {
  ...
  const serviceContract = defineServiceContract(
    ...
    (ref) => ({
      id: `integration.resources-service.${slug}@v1`,
      apiId: `integration.resources-service.${slug}@v1`,
      apiVersion: "1.0.0",
      ...
      rpc: {
        "Resources.Exercise": {
          version: "v1",
          subject: `rpc.v1.Integration.Resources.${slug}.Exercise`,
  ...
  const clientContract = defineAppContract(() => ({
    id: `integration.resources-client.${slug}@v1`,
    apiId: `integration.resources-client.${slug}@v1`,
    apiVersion: "1.0.0",
  ...
  const serviceName = `resources-fixture-service-${slug}`;
  ...
  return {
    ...
    clientContract,
    serviceName,
    clientName: `resources-fixture-client-${slug}`,
    resourceKey: `client.resource.${slug}`,
    connectService,
  };
}
