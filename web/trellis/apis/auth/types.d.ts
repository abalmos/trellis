...
export type AuthCapabilitiesListOutput = {
	entries: Array<{
		allows: Array<{
			action: ("call" | "invoke" | "observe" | "cancel" | "control" | "publish" | "subscribe" | "read" | "write" | "delete" | "submit" | "process" | "consume");
			target: ({
				api: string;
				kind: "apiSurface";
				name: string;
...
export type AuthDeploymentAuthorityGetInput = {
	authorityId: string;
};
...
export type AuthIdentityAuthorityGetInput = {
	authorityId: string;
};
...
export type AuthIdentityGrantsRevokeOutput = {
	success: boolean;
};
