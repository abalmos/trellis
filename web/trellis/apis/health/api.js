...
export const API_ID = "trellis.health@v1";
export const API_DIGEST = "8GFaxY8gvKvagqRIF43iaRpUN_40ukCylk_nwmFaZkg";
export const API = {
	"capabilities": { "trellis.health::read": { "allows": [
		{
			"action": "subscribe",
			"target": {
	...
	"description": "Trellis-managed participant health projection and operational history.",
