...
export type JobsCancelOutput = {
	job: {
		...
		service: string;
		startedAt?: string;
		state: ("pending" | "active" | "retry" | "completed" | "failed" | "cancelled" | "skipped" | "stale" | "expired" | "dead" | "dismissed");
		tries: number;
		trigger?: {
			id?: string;
			kind: ("schedule" | "operation" | "rpc" | "event" | "manualReplay" | "serviceCode" | "parentJob");
			operationId?: string;
			parentJobId?: string;
			requestId?: string;
			subject?: string;
...
export type JobsDismissDLQInput = {
	id: string;
	reason?: string;
};
...
export type JobsInspectOutput = {
	...
	related: Array<{
		...
		matchedBy?: ("trace" | "parent" | "root" | "operation" | "concurrency" | "wait");
		maxTries: number;
		progress?: {
			current?: number;
			message?: string;
	...
	timeline: Array<{
		...
		message?: string;
		previousState?: ("pending" | "active" | "retry" | "completed" | "failed" | "cancelled" | "skipped" | "stale" | "expired" | "dead" | "dismissed");
		progress?: {
			current?: number;
			message?: string;
			step?: string;
...
export type JobsMetricsInput = {
	...
	queueKey?: string;
	service?: string;
	state?: Array<("pending" | "active" | "retry" | "completed" | "failed" | "cancelled" | "skipped" | "stale" | "expired" | "dead" | "dismissed")>;
...
export type JobsQueryInput = {
	groupBy?: ("service" | "type" | "state" | "queueKey" | "trigger" | "runtimeBand");
	limit: number;
	offset?: number;
	queueKey?: string;
	...
	sort?: {
		direction?: ("asc" | "desc");
		field: ("updatedAt" | "queueAge" | "runtime" | "failureRate" | "retries" | "depth");
	};
	state?: Array<("pending" | "active" | "retry" | "completed" | "failed" | "cancelled" | "skipped" | "stale" | "expired" | "dead" | "dismissed")>;
	trigger?: string;
	type?: string;
...
export type JobsReplayDLQInput = {
	id: string;
	reason?: string;
};
