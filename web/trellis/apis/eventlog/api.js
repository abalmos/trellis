...
export const API_ID = "trellis.eventlog@v1";
export const API_DIGEST = "0dHI0vCQ_7EhGPQY10aK_hc5cEnnwdPIZrSIjwo7Nwg";
export const API = {
	"capabilities": {
		"trellis.eventlog::read": { "allows": [
			{
				"action": "call",
				"target": {
		...
		"trellis.eventlog::stream": { "allows": [{
			"action": "subscribe",
			"target": {
				"api": "trellis.eventlog@v1",
				"kind": "apiSurface",
