...
export const API_ID = "trellis.core@v1";
export const API_DIGEST = "WKuZkcLP-PPVvg5vymwb6n-QTpb43djf3DokC6UNqKE";
export const API = {
	"capabilities": { "trellis.core::authority.read": { "allows": [{
		"action": "call",
		"target": {
			"api": "trellis.core@v1",
			"kind": "apiSurface",
