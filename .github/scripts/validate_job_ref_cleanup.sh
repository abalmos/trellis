...
expected_files="$(printf '%s\n' \
  ...
  rust/crates/trellis/src/jobs/runtime_ref.rs \
  rust/crates/trellis/src/service/runtime_facade.rs \
  rust/crates/trellis/tests/integration/jobs.rs | sort)"
...
git add rust/crates/trellis/src/jobs/api.rs \
  rust/crates/trellis/src/jobs/runtime_ref.rs \
  rust/crates/trellis/src/service/runtime_facade.rs \
  rust/crates/trellis/tests/integration/jobs.rs
git commit -m "Use durable runtime state for JobRef"
