...
export const StateAdminDeleteRequestSchema = { "anyOf": [{
	"properties": {
		"contractDigest": {
			"minLength": 1,
			"type": "string"
...
export const StateAdminGetRequestSchema = { "anyOf": [{
	"properties": {
		"contractDigest": {
			"minLength": 1,
			"type": "string"
...
export const StateAdminGetResponseSchema = { "anyOf": [
	{
		"properties": { "found": {
			"const": false,
			"type": "boolean"
...
export const StateAdminListRequestSchema = { "anyOf": [{
	"properties": {
		"contractDigest": {
			"minLength": 1,
			"type": "string"
...
export const StateGetResponseSchema = { "anyOf": [
	{
		"properties": { "found": {
			"const": false,
			"type": "boolean"
...
export const StatePutResponseSchema = { "anyOf": [{
	"properties": {
		"applied": {
			"const": true,
			"type": "boolean"
