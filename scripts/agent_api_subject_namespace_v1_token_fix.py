...
text = replace_once(
    ...
    '        assert!(derive_rpc_subject("example/@v1", "v1", "Documents.Get").is_err());\n'
    '        assert!(derive_rpc_subject("example.☃@v1", "v1", "Documents.Get").is_err());\n',
    "API lineage subject tests",
)
path.write_text(text)

# API lineage is now embedded directly as subject tokens. Keep it on the
# conservative, cross-client NATS character set instead of merely banning
# wildcard characters.
